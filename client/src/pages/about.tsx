      ...
      <section className="w-full bg-black py-24  border-t-[1px] border-zinc-800">
        <div className="max-w-6xl pl-[1rem] pr-[1rem] mx-auto">
          <div className="mb-20 w-full">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-8 w-full">Redefining the Future of Work</h2>
            <p className="text-sm text-gray-300 leading-relaxed mb-8 text-justify w-full">
          ...
          <div className="flex flex-row gap-6 justify-center items-stretch w-full">
            ...
            <div className="group relative px-0 py-10 h-full lg:p-8 flex flex-col space-y-4 from-secondary/10 via-transparent to-transparent border-t border-border lg:border-l lg:border-t-0 lg:hover:bg-gradient-to-b md:flex-row lg:flex-col gap-10 overflow-hidden">
              ...
              <div className="max-w-sm group grow">
                <h3 className="text-xl text-white text-white">Intelligence at Core</h3>
              ...
              <div className="flex-1 flex flex-col">
                <div className="opacity-75 flex-1 pointer-events-none flex items-center justify-center">
                  {/* Example SVG effect (replace with your own if needed) */}
                  <svg className="w-[90%] h-[260px] mx-auto block opacity-40 group-hover:opacity-70 duration-100 group-hover:skew-y-[12deg] group-hover:scale-75 origin-center" width="489" viewBox="0 0 489 382" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g opacity="1">
            ...
            <div className="group relative px-0 py-10 h-full lg:p-8 flex flex-col space-y-4 from-secondary/10 via-transparent to-transparent border-t border-border lg:border-l lg:border-t-0 lg:hover:bg-gradient-to-b md:flex-row lg:flex-col gap-10 overflow-hidden">
              ...
              <div className="max-w-sm group grow">
                <h3 className="text-xl text-white text-white">Global Impact</h3>
              ...
              <div className="flex-1 flex flex-col">
                <div className=" flex-1 pointer-events-none flex items-center justify-center">
                  {/* Replaced SVG with base64 JPEG image */}
                  <img
                    ...
                    alt="Global Impact"
                    className="w-[90%] h-[260px] mx-auto block group-hover:opacity-70 duration-100 group-hover:scale-75 origin-center animate-fade-in object-contain"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="group relative px-0 py-10 h-full lg:p-8 flex flex-col space-y-4 from-secondary/10 via-transparent to-transparent border-t border-border lg:border-l lg:border-t-0 lg:hover:bg-gradient-to-b md:flex-row lg:flex-col gap-10 overflow-hidden">
              ...
              <div className="max-w-sm group grow">
                <h3 className="text-xl text-white text-white">Strategic Focus</h3>
              ...
              <div className="flex-1 flex flex-col">
                <div className=" flex-1 pointer-events-none flex items-center justify-center">
                  {/* Inline icon-white.svg */}
                  <svg className="w-[90%] h-[260px] mx-auto block group-hover:opacity-70 duration-100 group-hover:scale-75 origin-center animate-fade-in" viewBox="0 0 250 250" xmlns="http://www.w3.org/2000/svg">
      ...
      <section className="w-full bg-black py-24  border-t-[1px] border-zinc-800">
        <div className="max-w-6xl pl-[1rem] pr-[1rem] mx-auto">
          <div className="mb-20 text-left">
            <div className="text-xs tracking-widest text-gray-500 mb-2"># TEAM </div>
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">Meet the Makers</h2>
            <p className="text-lg text-gray-300 w-full p-2">
              A team of builders, thinkers, and creators—united by one purpose: making AI work for every business.
            </p>
            <div className="text-[1.125rem] font-bold text-white text-center mt-12">Our Core Team</div>
          </div>
          <div className="flex flex-col divide-y divide-zinc-700 pl-4">
            {/* Top Row */}
            <div className="flex flex-row divide-x divide-zinc-700">
              {/* Shiv Gadway */}
              <div className="flex-1 flex flex-col items-center py-8 cursor-pointer select-none relative">
                <div className="transition-all duration-300 hover:scale-105 transform-gpu origin-center">
                  <img src={shivImg} alt="Shiv Gadway" className="w-32 h-32 object-cover rounded-full mb-2 shadow-lg border-4 border-[#222] bg-[#181818] mx-auto" />
                  <h3 className="font-bold text-lg text-white mb-1 text-center">Shiv Gadway</h3>
                  <p className="text-gray-400 text-sm text-center">Developer</p>
                </div>
              </div>
              {/* Riyank */}
              <div className="flex-1 flex flex-col items-center py-8 cursor-pointer select-none relative">
                <div className="transition-all duration-300 hover:scale-105 transform-gpu origin-center">
                  <img src={riyankImg} alt="Riyank" className="w-32 h-32 object-cover rounded-full mb-2 shadow-lg border-4 border-[#222] bg-[#181818] mx-auto" />
                  <h3 className="font-bold text-lg text-white mb-1 text-center">Riyank Singh </h3>
                  <p className="text-gray-400 text-sm text-center">Developer</p>
                </div>
              </div>
              {/* Himnish Parmar */}
              <div className="flex-1 flex flex-col items-center py-8 cursor-pointer select-none relative">
                <div className="transition-all duration-300 hover:scale-105 transform-gpu origin-center">
                  <img src={himnishImg} alt="Himnish Parmar" className="w-32 h-32 object-cover rounded-full mb-2 shadow-lg border-4 border-[#222] bg-[#181818] mx-auto" />
                  <h3 className="font-bold text-lg text-white mb-1 text-center">Himnish Parmar</h3>
                  <p className="text-gray-400 text-sm text-center">CTO</p>
                </div>
              </div>
            </div>
            {/* Bottom Row */}
            <div className="flex flex-row divide-x divide-zinc-700">
              ...
              <div className="flex-1 flex flex-col items-center py-8 cursor-pointer select-none relative">
                <div className="transition-all duration-300 hover:scale-105 transform-gpu origin-center">
                  <img src={vyonishImg} alt="Vyonish Momaya" className="w-32 h-32 object-cover rounded-full mb-2 shadow-lg border-4 border-[#222] bg-[#181818] mx-auto" />
                  <h3 className="font-bold text-lg text-white mb-1 text-center">Vyonish Momaya</h3>
                  <p className="text-gray-400 text-sm text-center">COO</p>
                </div>
              </div>
              {/* Mohd. Sakib Raja */}
              <div className="flex-1 flex flex-col items-center py-8 cursor-pointer select-none relative">
                <div className="transition-all duration-300 hover:scale-105 transform-gpu origin-center">
                  <img src={sakibImg} alt="Mohd. Sakib Raja" className="w-32 h-32 object-cover rounded-full mb-2 shadow-lg border-4 border-[#222] bg-[#181818] mx-auto" />
                  <h3 className="font-bold text-lg text-white mb-1 text-center">Mohd. Sakib Raja</h3>
                  <p className="text-gray-400 text-sm text-center">CMO</p>
                </div>
              </div>
              {/* Shubham Parmar */}
              <div className="flex-1 flex flex-col items-center py-8 cursor-pointer select-none relative">
                <div className="transition-all duration-300 hover:scale-105 transform-gpu origin-center">
                  <img src={shubhamImg} alt="Shubham Parmar" className="w-32 h-32 object-cover rounded-full mb-2 shadow-lg border-4 border-[#222] bg-[#181818] mx-auto" />
                  <h3 className="font-bold text-lg text-white mb-1 text-center">Shubham Parmar</h3>
                  <p className="text-gray-400 text-sm text-center">CEO & Founder</p>
                </div>
              </div>
            </div>
          </div>
          {/* <div className="text-[1.125rem] font-bold text-white mt-8">Contributors</div> */}
          <section className="mt-8 text-center py-10  dark:bg-[#18181b] rounded-xl">
            <h2 className="text-[1.125rem] font-bold text-white text-center">Contributor Team</h2>
            <MarqueeContributors />
          </section>
        </div>
      </section>
