...
//     // update code here
//     // ✅ Dynamically scale logo based on screen height (so it fits vertically too)
//     const maxLogoScreenWidthPercentage = 0.7; // Occupy 70% of screen width
//     const maxLogoScreenHeightPercentage = 0.25; // Occupy 25% of screen height

//     // Calculate max possible logo width and height in world units (based on camera)
//     const vFOV = (camera.fov * Math.PI) / 180;
//     const screenHeightInUnits = 2 * Math.tan(vFOV / 2) * camera.position.z;
//     const screenWidthInUnits = screenHeightInUnits * camera.aspect;

//     //const logoAspectRatio = logoImgRef.current.width / logoImgRef.current.height;
//     let logoWidth = screenWidthInUnits * maxLogoScreenWidthPercentage;
//     let logoHeight = logoWidth / logoAspectRatio;

//     // ✅ Ensure height doesn't exceed max screen height percentage
//     const maxLogoHeight = screenHeightInUnits * maxLogoScreenHeightPercentage;
...
// here is the code for the hero section my code 2
import { useEffect, useRef, useState } from "react";
import logoSrc from "../assets/logo-white.svg";
import * as THREE from "three";
import vertexShader from "../assets/nebula.vert?raw";
...
export default function HeroSection() {
  ...
  useEffect(() => {
    ...
    let logoWidth;
    if (dimensions.width < 768) { // Mobile
      logoWidth = 0.6;
    ...
    const handleResize = () => {
      ...
      logoMesh.scale.set(newLogoWidth / logoWidth, newLogoHeight / logoHeight, 1);
    };
...
// here is the code for the hero section original code 
// HeroSection.tsx
// HeroSection.tsx
// import { useEffect, useRef, useState } from "react";
// import logoSrc from "../assets/logo-white.svg";
